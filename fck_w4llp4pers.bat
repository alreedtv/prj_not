@echo off
@echo  Установщик SUPERSANEK_WALLPAPERHACK запущен.
powershell write-host -BackgroundColor White -ForegroundColor Black Запускаем установку групповых политик... Пожалуйста, подождите.
...
powershell write-host -BackgroundColor White -ForegroundColor Black Ежедневное обновление обоев установлено.
